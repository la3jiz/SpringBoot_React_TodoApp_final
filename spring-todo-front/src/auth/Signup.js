...
<div className='flex justify-center items-center mt-12'>
  ...
  <div className="field">
    ...
    <input className="form_input" name="Name" type="text" placeholder="Name" id="username"/>
  </div>
  <div className="field">
    <label className='form_label' htmlFor="username">Eamil</label>
    <input className="form_input" name="Eamil" type="text" placeholder="Eamil" id="username"/>
  </div>
  <div className="field">
  ...
  <div className="field">
    <button className="auth_btn">Singup</button>
  </div>
</form>
    </div>
